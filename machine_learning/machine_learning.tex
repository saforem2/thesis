...
\begin{algorithm}[htpb]
    ...
    \Input{A data set $X = \{(\vec{x}_{1}, t_{1}), \ldots, (\vec{x}_{N},
      t_{N})\}$ consisting of $N$ input-output pairs, the learning rate
      $\alpha$, the loss function $\mathcal{L}$, and the activation function
      $h$}\;
    %
    \begin{enumerate}
